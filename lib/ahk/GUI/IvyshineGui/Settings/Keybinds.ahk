...
IvyshineGui.Add("Text", "xs yp+6 h17 -Wrap +BackgroundTrans", "Forward Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Left Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Backward Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Right Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Camera Left:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Camera Right:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Camera In:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Camera Out:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Reset Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h17 -Wrap +BackgroundTrans", "Chat Key:")
...
IvyshineGui.Add("Text", "xs yp+22 h17 -Wrap +BackgroundTrans", "Key Delay:")
