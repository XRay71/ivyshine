...
IvyshineGui.Add("GroupBox", "x434 y8 w106 h223 Section", "Keybinds")
IvyshineGui.Add("Text", "xs+8 ys+20 wp-12 0x10 Section")

IvyshineGui.SetFont()
IvyshineGui.SetFont("s8", "Calibri")

IvyshineGui.Add("Text", "xs yp+6 h20 -Wrap +BackgroundTrans", "Forward Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Left Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Backward Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Right Key:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Camera Left:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Camera Right:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Camera In:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Camera Out:")
...
IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Reset Key:")
...
IvyshineGui.Add("Text", "xs yp+22 h20 -Wrap +BackgroundTrans", "Key Delay:")
