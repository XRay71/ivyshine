...
ShiftlockMovingCheckBox := IvyshineGui.Add("CheckBox", "xs yp+19 h20 w120 -Wrap vShiftLockWhenPossibleCheckBox Checked" Globals["Settings"]["Miscellaneous"]["ShiftlockMoving"], "Shiftlock moving?")
...
BalloonConvertIntervalText := IvyshineGui.Add("Text", "x+4 yp+1 h20 -Wrap +BackgroundTrans vBalloonConvertIntervalText Hidden" (Globals["Settings"]["Miscellaneous"]["BalloonConvertSetting"] == "Every" ? "0" : "1"), "min.")

IvyshineGui.Add("Text", "xs yp+19 h20 -Wrap +BackgroundTrans", "Reset Multiplier: ")
...
IvyshineGui.Add("Text", "xs yp+23 h20 -Wrap +BackgroundTrans", "Reconnect Interval: ")
...
ReconnectIntervalText := IvyshineGui.Add("Text", "x+2 yp+1 h20 -Wrap +BackgroundTrans vReconnectIntervalText", (Globals["Settings"]["Miscellaneous"]["ReconnectInterval"] == 1 ? " hour," : " hours,"))
